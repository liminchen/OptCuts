...
\caption{Comparison between the OptCuts using our standrad topology operations (left) and OptCuts using the EB cutting strategy (right) for decreasing distortion bounds (top to bottom). EB cuts are aggressive---leading to faster convergence but at the cost of larger seam-length measures at convergence.}
\label{fig:comp_GI}
\end{figure}
