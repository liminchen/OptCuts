...
\end{align} 
At each iteration, to find $\lambda^k$ we simply fix vertices and topology to  $U^{k-1},T^{k-1}$. Optimality of (\ref{eq:al} then gives us our corresponding dual update in closed form
%\begin{align}
