...
\end{align}
%
Evaluating $d$ requires solving continuous distortion optimization with respect to stencil vertices $U^{i,j}$, for which we use the Newton-type smooth descent routine (see Section~\ref{sec:descentStep} for details).
