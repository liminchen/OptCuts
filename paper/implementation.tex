...
Of the $N$ examples computed with OptCuts in Section~\ref{sec:results} this cycling behavior appears in $M\%$.\danny{Minchen: add missing data for the above and confirm correctness.} 
