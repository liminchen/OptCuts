...
For most texture applications one needs to ensure global bijecivity, we incorporate this into our energy following Jiang et al.~\shortcite{Jiang2017Simplicial}. This is realized by repeatedly triangulating the void regions of the UV maps and augment our $E_d$ with a degeneracy prevention energy during the optimization. The augmented energy is not considered when checking the distortion bound. Moreover, our framework stays the same when solving this extended problem.
